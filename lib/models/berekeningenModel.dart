...
class BerekeningenModel {
  ...
  factory BerekeningenModel.fromJson(Map<String, dynamic> json) => BerekeningenModel(
    ...
    payee: json["payee"],
    premieBedragZiektekostenVerzekeringsWetWerkgeversbijdrage: json["premieBedragZiektekostenVerzekeringsWetWerkgeversbijdrage"].toDouble(),
    premieBedragZiektekostenVerzekeringsWetWerknemersbijdrage: json["premieBedragZiektekostenVerzekeringsWetWerknemersbijdrage"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "payee": payee,
    "premieBedragZiektekostenVerzekeringsWetWerkgeversbijdrage": premieBedragZiektekostenVerzekeringsWetWerkgeversbijdrage,
    "premieBedragZiektekostenVerzekeringsWetWerknemersbijdrage": premieBedragZiektekostenVerzekeringsWetWerknemersbijdrage,
...
class Collectieve {
  ...
  factory Collectieve.fromJson(Map<String, dynamic> json) => Collectieve(
    ...
    totGen: json["totGen"],
    saldoCorrectiesVoorgaandTijdvak: List<SaldoCorrectiesVoorgaandTijdvak>.from(json["saldoCorrectiesVoorgaandTijdvak"].map((x) => SaldoCorrectiesVoorgaandTijdvak.fromJson(x))),
  );
